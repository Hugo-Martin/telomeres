% Function qui tire au hasard numel(x) longueurs initiales de télomères
% selon la loi asymptotique. Utilise crucialement que le vecteur
% repartition est trié.


function mysample = random_generation_initial_length(n,support,repartition)
...
% OUPUT:
% mysample: sorted n-sample of realizations of the law of initial length,
% as a column vector
